"""
Script de chargement des données - Version Docker
Ce script doit être exécuté DANS le conteneur Docker pour éviter les problèmes d'encodage Windows
"""
import pandas as pd
...
CONNECTION_STRING = "postgresql://postgres:postgres@postgres:5432/games_db"

def load_bronze_data():
    engine = create_engine(CONNECTION_STRING)

    df = pd.read_excel('/home/jovyan/work/data/Bronze/games_brut.xlsx')
